			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6">
								<img src="<?= base_url() ?>asset/images/section-image-1.png" alt="">
								<div class="space"></div>
							</div>
							<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="<?= base_url() ?>asset/images/testimonial-1.png" alt="">
							</div>
							<div class="media-body">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="<?= base_url() ?>asset/images/testimonial-2.png" alt="">
							</div>
							<div class="media-body">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="<?= base_url() ?>asset/images/testimonial-3.png" alt="">
							</div>
							<div class="media-body">
						...
						<div class="row">
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?= base_url() ?>asset/images/client-1.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?= base_url() ?>asset/images/client-2.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?= base_url() ?>asset/images/client-3.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?= base_url() ?>asset/images/client-4.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?= base_url() ?>asset/images/client-5.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?= base_url() ?>asset/images/client-6.png" alt="client">
								</div>
							</div>
						</div>
					</div>
